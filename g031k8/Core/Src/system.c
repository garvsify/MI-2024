...
//const uint16_t TIM16_prescaler_divisors[12] = {4096, 2048, 1024, 512, 256, 128, 64, 32, 16, 8, 4, 2};
...
volatile uint16_t TIM16_final_start_value_exit_locked = 0;
volatile uint8_t TIM16_prescaler_divisors_final_index_exit_locked = 0;
volatile uint16_t prev_duty = 0;
volatile enum Validate freq_gen_isr_initiated_and_finished = NO;
volatile uint8_t pot_rotation_corrected_global = 0;
volatile enum Validate adc_conversion_initiated_and_values_ready = NO;
volatile enum Validate ISR_triggered_whilst_processing = NO;
