...
struct Delay_Line{
	...
	volatile uint16_t duty_delay_line_storage_array[1024 + 1]; //one index larger than the number of indexes (wave samples) to allow us to 'wrap' the array into a kind of circular buffer
