...
//STRUCT VARIABLES
extern volatile struct Params params; //running variables of the oscillator/s
extern volatile struct Params params_manual; //values of manual pots that are, dependent on mode, copied into running params
extern volatile struct Params params_to_be_loaded; //'to be loaded' params for the oscillators for when I/P capture states are active
extern volatile struct Params params_working; //upon overflow of re-elapse timer (TIM3), 'to_be_loaded' values are copied into this struct
extern volatile struct Delay_Line delay_line;
