...
#define PRESET_SAVE_SELECT_IDLE_COUNT 800000 //roughly 10s

#define POTS_COUNTER_HAS_TIMED_OUT (0b1 << 11)

#define TAP_TEMPO_SWITCH_PRESET_SELECT_MODE_ADVANCE_COUNT_MIN 2000 //with LPTIM1_CCR_CHECK == 250
...
#define TAP_TEMPO_SWITCH_PRESET_SAVE_MODE_ADVANCE_COUNT_MIN 4000 //with LPTIM1_CCR_CHECK == 250
...
#define TAP_TEMPO_SWITCH_FACTORY_RESET_COUNT_MAX TAP_TEMPO_SWITCH_FACTORY_RESET_COUNT_MIN + 4000
