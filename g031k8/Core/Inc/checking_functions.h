...
#define TAP_TEMPO_SWITCH_PRESET_SELECT_MODE_ADVANCE_COUNT 2500 //with LPTIM1_CCR_CHECK == 250
#define TAP_TEMPO_SWITCH_PRESET_SAVE_MODE_ADVANCE_COUNT 5000 //with LPTIM1_CCR_CHECK == 250
#define TAP_TEMPO_SWITCH_PRESET_SAVE_MODE_ADVANCE_MAX_COUNT TAP_TEMPO_SWITCH_PRESET_SAVE_MODE_ADVANCE_COUNT + 2000
#define TAP_TEMPO_SWITCH_PRESET_SAVE_COUNT 400
